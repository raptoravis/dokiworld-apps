...
The project uses the published `@dokiworld/app-sdk@^3.1.0` package by default. When developing an unpublished SDK change, it can temporarily use a sibling checkout of `dokiworld.git`:
